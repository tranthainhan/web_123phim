    ...
    <div className="mt-5 container news-list">
      ...
      >
        <li className="nav-item nowShowingFilms_container">
          <a
            ...
            id="pills-nowShowingFilms-news-tab"
            data-toggle="pill"
            href="#pills-nowShowingFilms-news"
            role="tab"
            aria-controls="pills-nowShowingFilms-news"
            aria-selected="true"
          >
            Điện Ảnh 24h
          </a>
        ...
        <li className="nav-item upComingFilms_container">
          <a
            ...
            id="pills-upComingFilms-news-tab"
            data-toggle="pill"
            href="#pills-upComingFilms-news"
            role="tab"
            aria-controls="pills-upComingFilms-news"
            aria-selected="false"
          >
            Review
          </a>
      ...
      <div className="tab-content" id="pills-news-tabContent">
        <div
          ...
          id="pills-nowShowingFilms-news"
          role="tabpanel"
          aria-labelledby="pills-nowShowingFilms-news-tab"
        >
          {show.list.map((film, index) => {
            return (
        ...
        <button className="btn-create-news" onClick={createNews}>
          {" "}
          XEM THÊM
        </button>
        ...
        <div
          ...
          id="pills-upComingFilms-news"
          role="tabpanel"
          aria-labelledby="pills-upComingFilms-news-tab"
        ></div>
      </div>
    </div>
  );
